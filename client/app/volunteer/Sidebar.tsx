...
import { CalendarClock, CalendarDays, LayoutDashboard, type LucideIcon } from "lucide-react";
...
const volunteerNavItems: VolunteerNavItem[] = [
  ...
  { title: "Shift Schedule", url: "/volunteer/shift-schedule", icon: CalendarClock },
  { title: "Event Schedule", url: "/volunteer/event-schedule", icon: CalendarDays },
];
